    ...
    <main className="min-h-screen bg-[#f8f4ec] px-6 py-10 text-[#07161d]">
      <div className="mx-auto flex min-h-[calc(100vh-80px)] max-w-md flex-col justify-center">
        ...
        <div className="relative overflow-hidden rounded-[36px] border border-black/5 bg-white p-8 shadow-[0_20px_60px_rgba(0,0,0,0.06)] md:p-10">
          <div className="absolute left-[-80px] top-[-80px] h-[220px] w-[220px] rounded-full bg-[#0d6b4e]/10 blur-3xl" />
          ...
          <div className="relative">
            ...
            <p className="mt-4 text-base leading-7 text-black/55">
              Access your wallet, groups, payouts, and contribution activity.
            </p>
            ...
            <form onSubmit={handleLogin} className="mt-10 space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="mt-2 w-full rounded-full bg-[#07161d] px-6 py-4 text-sm font-black text-white shadow-xl shadow-black/10 transition hover:-translate-y-[2px] disabled:cursor-not-allowed disabled:opacity-70"
              >
            ...
            <p className="mt-8 text-center text-sm font-semibold text-black/55">
              ...
              <Link href="/signup" className="font-black text-[#0d6b4e]">
                Create one
              </Link>
            </p>
          </div>
